...
if (isset($_GET['p_id'])) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $post_comment_count = $row['post_comm_count'];
...
if (isset($_POST['update_post'])) {
    ...
    $query = "UPDATE posts SET post_category_id = $post_category_id, post_title = '$post_title', 
                post_author = '$post_user', post_date = now(), post_image = '$post_image', 
                post_content = '$post_content', post_tags = '$post_tags', 
                post_comm_count = $post_comment_count, post_status = '$post_status' 
